const EligibilityCriteria =()=>{
    return(
        ...
        <div className="flex flex-col md:flex-row items-center justify-center bg-[#001437] text-white p-6 rounded-xl md:p-10 md:gap-8 w-full md:w-[65%] relative md:min-h-[300px]">
          
          <div className="flex-1 text-center md:text-left z-10 mb-8 md:mb-0">
